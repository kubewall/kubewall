...
// Namespace and Cluster IP render through here, and DataTable sizes those columns to
// fit their longest value, so this cell's horizontal padding is baked into CELL_HORIZONTAL_SPACE in
