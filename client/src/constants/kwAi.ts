...
const KW_AI_PROVIDERS = [
  ...
  },
  {
    ...
    urlHint: "OrcaRouter gateway — OpenAI-compatible endpoint with adaptive routing, failover, guardrails and agent governance. Default: https://api.orcarouter.ai/v1",
