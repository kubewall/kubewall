...
type ClusterRoleBindingDetailsMetadata = {
  /**
...
type ClusterRoleBindingDetails = {
   ...
   */
  kind?: "ClusterRoleBinding" | null;
  /**
   * ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
   */
  metadata: ClusterRoleBindingDetailsMetadata;
  /**
...
export {
  ClusterRoleBindingsResponse,
  ClusterRoleBindingsListHeader,
  ClusterRoleBindingDetails,
  ClusterRoleBindingDetailsMetadata
};