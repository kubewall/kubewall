...
type ClusterRoleDetailsMetadata = {
  /**
...
type ClusterRoleDetailsRoleSelectors = | ({
  /**
...
type ClusterRoleDetails = {
  ...
  aggregationRule?: {
     ...
     */
    clusterRoleSelectors: ClusterRoleDetailsRoleSelectors[] | null;
    [k: string]: unknown;
  } | null;
  /**
   ...
   */
  metadata: ClusterRoleDetailsMetadata;
  /**
   * Rules holds all the PolicyRules for this ClusterRole
   */
  rules: ClusterRoleDetailsRules;
  [k: string]: unknown;
}
...
export {
  ...
  ClusterRoleDetails,
  ClusterRoleDetailsMetadata,
  ClusterRoleDetailsRules,
  ClusterRoleDetailsRoleSelectors
};