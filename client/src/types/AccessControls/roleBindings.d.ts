...
type RoleBindingDetailsSubjects = | ({
  /**
...
type RoleBindingDetails = {
   ...
   */
  kind?: "RoleBinding" | null;
  /**
   * ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
   */
  metadata: RoleBindingDetailsMetadata;
  /**
   ...
   */
  subjects: RoleBindingDetailsSubjects;
  [k: string]: unknown;
}
...
export {
  ...
  RoleBindingDetails,
  RoleBindingDetailsMetadata,
  RoleBindingDetailsSubjects
};