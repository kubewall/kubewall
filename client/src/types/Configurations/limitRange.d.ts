...
type LimitRangeDetailsMetadata = {
  /**
...
type LimitRangeDetails = {
   ...
   */
  metadata: LimitRangeDetailsMetadata;
  /**
   * LimitRangeSpec defines a min/max usage limit for resources that match on kind.
   */
  spec: LimitRangeDetailsSpec;
...
export {
  ...
  LimitRangeDetails,
  LimitRangeDetailsMetadata,
  LimitRangeDetailsSpec
};