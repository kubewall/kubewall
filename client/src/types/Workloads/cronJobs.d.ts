...
type CronJobs = CronJobsHeader;

type CronJobDetailsMetadata = {
  /**
...
type CronJobDetails = {
  ...
  * ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
  */
 metadata: CronJobDetailsMetadata;
 /**
  * CronJobSpec describes how the job execution will look like and when it will actually run.
  */
 spec: CronJobDetailsSpec;
 /**
  * CronJobStatus represents the current state of a cron job.
  */
 status: CronJobDetailsStatus;
}
...
export {
  ...
  CronJobsResponse,
  CronJobDetails,
  CronJobDetailsMetadata,
  CronJobDetailsSpec,
  CronJobDetailsStatus
};
