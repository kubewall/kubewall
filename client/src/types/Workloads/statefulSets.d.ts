...
type StatefulSet = StatefulSetsHeader;

type StatefulSetDetailsMetadata = {
  /**
...
type StatefulSetDetailsSpec = {
  ...
  | ({
     ...
     */
    kind?: "PersistentVolumeClaim" | null
    /**
     * ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
     */
    metadata?: {
...
type StatefulSetDetails = {
   ...
   * ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
   */
  metadata: StatefulSetDetailsMetadata;
  /**
   * A StatefulSetSpec is the specification of a StatefulSet.
   */
  spec: StatefulSetDetailsSpec;
  /**
   * StatefulSetStatus represents the current state of a StatefulSet.
   */
  status: StatefulSetDetailsStatus
}
...
export {
  ...
  StatefulSetsHeader,
  StatefulSet,
  StatefulSetDetailsMetadata,
  StatefulSetDetailsSpec,
  StatefulSetDetailsStatus,
  StatefulSetDetails
};
